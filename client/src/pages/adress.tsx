            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <div className="mt-6 pt-6 border-t border-gray-100">
                ...
                <div className="flex items-center">
                  ...
                  <span
                    className={`${
                      status.isOpen ? "bg-status-success" : "bg-status-error"
                ...
                <a
                  ...
                  className="mt-4 inline-flex items-center text-secondary hover:text-secondary/80 font-medium"
                >
                  <NavigationIcon className="h-4 w-4 mr-1" /> Voir l'itinéraire
                </a>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <div className="space-y-3">
                <a
                  ...
                  className="flex items-center justify-center w-full bg-secondary hover:bg-secondary/90 text-white py-3 px-4 rounded-lg transition-colors"
                >
                ...
                <a
                  ...
                  className="flex items-center justify-center w-full bg-whatsapp hover:bg-whatsapp/90 text-white py-3 px-4 rounded-lg transition-colors"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FaWhatsapp className="h-5 w-5 mr-2" /> Contacter sur WhatsApp
                </a>

                <a
                  href={`mailto:${currentLocation.email}`}
                  className="flex items-center justify-center w-full bg-primary hover:bg-primary/90 text-white py-3 px-4 rounded-lg transition-colors"
                >
              ...
              <div className="flex justify-center mt-6 space-x-4">
                <a
                  href="#"
                  className="bg-[#1877F2] hover:bg-[#1877F2]/90 text-white w-10 h-10 rounded-full flex items-center justify-center"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Facebook"
                >
                ...
                <a
                  href="#"
                  className="bg-gradient-to-r from-[#833AB4] via-[#E1306C] to-[#FFDC80] hover:opacity-90 text-white w-10 h-10 rounded-full flex items-center justify-center"
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="bg-gradient-to-r from-secondary to-primary text-white p-6 rounded-xl shadow-sm">
              <div className="flex flex-col md:flex-row justify-between items-center">
                ...
                <div className="flex gap-3">
                  <a
                    href={`tel:${currentLocation.phone.replace(/\s+/g, "")}`}
                    className="bg-white text-secondary hover:bg-white/90 px-6 py-2 rounded-lg transition-colors font-medium text-sm"
                  >
                    Appeler
                  </a>
                  <a
                    href="https://wa.me/+243814264458"
                    className="bg-whatsapp hover:bg-whatsapp/90 text-white px-6 py-2 rounded-lg transition-colors font-medium text-sm flex items-center"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
